...
class Program
{
    static void Main(string[] args)
    {
        ...
        video3.SetNewComment("tati_edits11", "This is literally the perfect tutorial for beginners, he literally just explained it to us like we're 5 year olds.  I love it.");
        ...
        videosList = new List<Video>(){video1, video2, video3};
